...
class RegistrationEmailCodeActivity : BaseThemeActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSendVerificationCode.setOnClickListener {
            ...
            if (email.isNotEmpty() && password.isNotEmpty()) {
                ...
                // Change button text
                binding.btnSendVerificationCode.text = getString(R.string.Registering)
                // Show progress bar
                ...
                GlobalScope.launch(Dispatchers.IO) {
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        binding.btnSendVerificationCode.text = getString(R.string.register)
                    ...
                    when (responseCode) {
                        200 -> {
                            runOnUiThread {
                                ...
                                navigateToVerifyActivity(email)
                            }
                        }
                        409 -> {
                            runOnUiThread {
    ...
    private fun navigateToVerifyActivity(email: String) {
